...
1. Add /logs traces to key locations in the code.
...
Never ask the user to "try it out" or "let me know if it works" - verify everything yourself using the browser tools and logs traces.
