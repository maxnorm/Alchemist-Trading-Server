...
async def stop_experiment(
    ...
    if experiment.status != "training":
        raise HTTPException(status_code=400, detail="Experiment is not currently training")
...
@router.post("/experiments/{id}/clone", response_model=ExperimentResponse, status_code=201)
