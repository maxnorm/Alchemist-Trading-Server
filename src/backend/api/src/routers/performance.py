...
async def get_portfolio_performance(
    ...
    try:
        return performance_service.get_portfolio_performance(
            db, start_date, end_date, period
        )
...
@router.get(
    ...
    response_model=List[PerformanceBreakdownResponse],
)
async def get_performance_breakdown(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get performance breakdown: {str(e)}"
        )
...
async def list_model_performance(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to list model performance: {str(e)}"
        )
...
@router.get(
    "/performance/models/{model_id}/equity-curve", response_model=EquityCurveResponse
)
async def get_model_equity_curve(
    ...
    try:
        return performance_service.get_model_equity_curve(
            db, model_id, start_date, end_date
        )
    except Exception as e:
        raise HTTPException(
            status_code=500, detail=f"Failed to get model equity curve: {str(e)}"
        )


@router.get(
    "/performance/models/{model_id}/trades", response_model=TradeHistoryResponse
)
async def get_model_trades(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get model trades: {str(e)}"
        )
...
async def get_model_statistics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get model statistics: {str(e)}"
        )
...
async def get_model_comparison(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get model comparison: {str(e)}"
        )
...
async def export_portfolio_report(
    ...
    try:
        return performance_service.export_portfolio_report(
            db, format, start_date, end_date
        )
    except Exception as e:
        raise HTTPException(
            status_code=500, detail=f"Failed to export portfolio report: {str(e)}"
        )
...
async def export_model_report(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to export model report: {str(e)}"
        )
