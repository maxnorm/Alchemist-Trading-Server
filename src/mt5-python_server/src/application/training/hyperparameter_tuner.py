...
class HyperparameterTuner:
    ...
    def suggest_hyperparameters(self, trial: optuna.Trial) -> Dict[str, Any]:
        ...
        return {
            ...
            "per_beta_increment": trial.suggest_loguniform(
                "per_beta_increment", 1e-4, 1e-2
            ),
            # Memory size
            "memory_size": trial.suggest_categorical(
    ...
    def optimize(
        ...
        self.logger.info(
            f"Optimization complete. Best value: {self.study.best_value:.4f}"
        )
