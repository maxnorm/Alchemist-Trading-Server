...
class EnvironmentConfig:
    ...
    def from_env(cls) -> 'EnvironmentConfig':
        ...
        return cls(
            window_size=int(os.getenv('ENV_WINDOW_SIZE', str(TradingConstants.DEFAULT_WINDOW_SIZE))),
            features_per_pair=int(os.getenv('ENV_FEATURES_PER_PAIR', str(TradingConstants.DEFAULT_FEATURES_PER_PAIR))),
