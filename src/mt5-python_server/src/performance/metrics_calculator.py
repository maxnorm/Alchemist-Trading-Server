...
class PerformanceMetricsCalculator:
    ...
    def calculate_sharpe_ratio(
        self, returns: List[float], risk_free_rate: float = 0.0, annualized: bool = True
    ) -> float:
        """
    ...
    def calculate_max_drawdown(self, equity_curve: List[Dict]) -> Tuple[float, float]:
        """
    ...
    def calculate_all_metrics(
        ...
        if period != "all_time":
            ...
            trades = [
                ...
                for t in trades
                if t.get("opened_at")
                and datetime.fromisoformat(str(t["opened_at"])) >= start_date
            ]
        ...
        if closed_trades:
            ...
            returns = [
                t["pnl"] / 10000.0 for t in closed_trades
