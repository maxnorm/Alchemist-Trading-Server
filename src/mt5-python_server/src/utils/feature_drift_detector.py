...
class FeatureDriftDetector:
    ...
    def __init__(self, reference_features: Dict[str, np.ndarray], drift_threshold: float = 0.25):
        """
    ...
    def get_drift_scores(self, current_features: Dict[str, np.ndarray]) -> Dict[str, float]:
        """
