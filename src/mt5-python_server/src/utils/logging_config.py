...
def _get_log_directory() -> str:
    ...
    for _ in range(5):  # Go up max 5 levels
        if os.path.exists(os.path.join(project_root, 'docker-compose.yml')) or \
...
def get_structured_logger(component_name: str, log_file_name: Optional[str] = None) -> StructuredLogger:
    """
