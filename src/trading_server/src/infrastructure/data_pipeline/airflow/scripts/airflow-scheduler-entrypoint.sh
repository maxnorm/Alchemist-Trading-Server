#!/bin/bash
# Airflow Scheduler Entrypoint Script
# This script handles log directory setup and starts the Airflow scheduler

echo "=========================================="
echo "Airflow Scheduler Entrypoint"
echo "=========================================="
...
if [ "$PERMISSION_ERROR" = "true" ]; then
    ...
    echo "   docker compose stop airflow-scheduler"
    echo ""
